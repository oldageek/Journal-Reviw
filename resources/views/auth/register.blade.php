            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="form-group row">
                            <label for="dependence" class="col-md-4 col-form-label text-md-right">{{ __('Dependence') }}</label>

                            <div class="col-md-6">
                                <input id="dependence" type="text" class="form-control @error('dependence') is-invalid @enderror" name="dependence" value="{{ old('dependence') }}" required autocomplete="dependence" autofocus>
